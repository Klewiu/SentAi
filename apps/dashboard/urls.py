...
from .views import (
    ...
    ManualPlanMarkPaidView,
    ManualPlanDisableView,
    ManualPlanConfirmView,
    ManualPlanInvoiceCreateView,
    BillingInvoicesAdminView,
...
urlpatterns = [
    ...
    path("billing/invoices/", BillingInvoicesAdminView.as_view(), name="billing-invoices-admin"),
    path("billing/invoices/customer/<int:pk>/", BillingCustomerInvoicesDetailView.as_view(), name="billing-customer-invoices"),
    path("billing/invoices/stripe/<int:pk>/add/", StripePaymentInvoiceCreateView.as_view(), name="stripe-payment-invoice"),
    path("billing/manual/<int:pk>/mark-paid/", ManualPlanMarkPaidView.as_view(), name="manual-plan-mark-paid"),
    path("billing/manual/<int:pk>/disable/", ManualPlanDisableView.as_view(), name="manual-plan-disable"),
    path("billing/manual/<int:pk>/invoice/", ManualPlanInvoiceCreateView.as_view(), name="manual-plan-invoice"),
